...
class PecasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create peca" do
    assert_difference("Peca.count") do
      post pecas_url, params: { peca: { name: @peca.name, quantidade: @peca.quantidade, valor: @peca.valor } }
    end
  ...
  test "should update peca" do
    patch peca_url(@peca), params: { peca: { name: @peca.name, quantidade: @peca.quantidade, valor: @peca.valor } }
