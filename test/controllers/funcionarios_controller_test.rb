...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference("Funcionario.count") do
      post funcionarios_url, params: { funcionario: { endereco: @funcionario.endereco, name: @funcionario.name, phone: @funcionario.phone } }
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { endereco: @funcionario.endereco, name: @funcionario.name, phone: @funcionario.phone } }
