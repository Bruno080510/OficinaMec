...
class EquipesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipe" do
    assert_difference("Equipe.count") do
      post equipes_url, params: { equipe: { descricao: @equipe.descricao, nome: @equipe.nome } }
    end
  ...
  test "should update equipe" do
    patch equipe_url(@equipe), params: { equipe: { descricao: @equipe.descricao, nome: @equipe.nome } }
