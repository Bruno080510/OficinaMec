...
class MecanicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mecanico" do
    assert_difference("Mecanico.count") do
      post mecanicos_url, params: { mecanico: { endereco: @mecanico.endereco, nome: @mecanico.nome, phone: @mecanico.phone } }
    end
  ...
  test "should update mecanico" do
    patch mecanico_url(@mecanico), params: { mecanico: { endereco: @mecanico.endereco, nome: @mecanico.nome, phone: @mecanico.phone } }
